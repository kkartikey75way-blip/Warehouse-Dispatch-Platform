...
const ShipmentDetailsModal = ({ isOpen, onClose, shipment }: ShipmentDetailsModalProps) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <Card className="relative w-full max-w-2xl bg-white border-none shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] overflow-hidden rounded-[2.5rem] p-0 animate-in fade-in zoom-in duration-300">
                {/* Header Section */}
                <div className="bg-slate-950 p-8 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex justify-between items-start">
                        <div>
                            ...
                            <h2 className="text-3xl font-black tracking-tight">{shipment.trackingId}</h2>
                        </div>
                        <button
                            onClick={onClose}
